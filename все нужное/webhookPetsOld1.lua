...
local WebhookURL = "https://webhook.lewisakura.moe/api/webhooks/1485155972270788721/KrdNQE9PXsI55wMkzQBwVMpN0pd9cZKvM3VKXdbfg9joY_6TqzdTduhyw-JEuWfHgAEG"
...
local function runTest()
    local testName = "Titanic Komaru" 
    local testId = "https://i.ibb.co/xqrkGhPf/image-2.png" 

    if testName == "" or testId == "" then
        print("⚠️ [Komaru Test]: Данные для теста не указаны. Пропуск.")
        return 
    end
